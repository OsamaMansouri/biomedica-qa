...
CASES = [
    ...
    ("Payment", "Valid promo code reduces total visibly", "Sign-off", "P1", "Active promo in admin", "Known valid code",
     "Apply promo at checkout before pay", "Discount obvious in summary"),
    ...
    ("Payment", "Invalid or expired promo rejected", "Negative", "P1", "Checkout", "Bad and expired codes",
     "Try fake code then expired code", "Clear promo error no silent fail"),
    ...
    ("Admin", "Promo code created works on checkout", "Sign-off", "P1", "Promo admin access", "New test promo",
     "Create promo apply on staging checkout", "Discount applies as configured"),
